...
import Resident_Info_Sucessnew as RS
...
class Ui_viewReservations(object):
    ...
    def logOut(self,viewReservations):
    ...
    def back(self,viewReservations):
        self.Reservation = QtWidgets.QMainWindow()
        self.ui = R.Ui_Reservation()
        self.ui.setupUi(self.Reservation)
        self.Reservation.show()
        viewReservations.close()


    def showResInfo(self):
        result = self.mc.getResInfo()
        _translate = QtCore.QCoreApplication.translate
        print(result)
        self.reservationIdLabel.setText(_translate("modifyEmployee", str(result[0][0])))
        self.dateOfReservationLabel.setText(_translate("modifyEmployee", str(result[0][1])))
        self.residentIdLabel.setText(_translate("modifyEmployee", str(result[0][2])))
        self.floorIdLabel.setText(_translate("modifyEmployee", str(result[0][3])))
        self.buildingIdLabel.setText(_translate("modifyEmployee", str(result[0][4])))
        self.roomLabel.setText(_translate("modifyEmployee", str(result[0][5])))
        self.receptionistIdLabel.setText(_translate("modifyEmployee", str(result[0][6])))
        return

    def showReceptionistDashboard(self,viewReservations):
...
"image: url(driver-license.png);")
        ...
        self.doneButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showReceptionistDashboard(viewReservations))
        self.doneButton.setGeometry(QtCore.QRect(590, 440, 351, 61))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        ...
        self.doneButton.setStyleSheet("QPushButton {\n"
                                     ...
                                     "color: white;\n"
                                     "}")
        self.doneButton.setObjectName("deleteButton")
        self.logOutButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.logOut(viewReservations))
...
"")
        ...
        self.backButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.back(viewReservations))
...
"")
        ...
        self.reservationIdLabel = QtWidgets.QLabel(self.centralwidget)
        self.reservationIdLabel.setGeometry(QtCore.QRect(130, 250, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.reservationIdLabel.setFont(font)
        self.reservationIdLabel.setStyleSheet("color: rgb(122, 122, 122);\n"
"border-radius:0px;\n"
"border-bottom: 3px solid #3c79b5;\n"
"padding-bottom:0px;\n"
"color: rgb(170, 0, 0);")
        self.reservationIdLabel.setText("")
        self.reservationIdLabel.setObjectName("reservationIdLabel")
        ...
        self.reservationIdLabel.raise_()
    ...
    def retranslateUi(self, viewReservations):
        ...
        self.doneButton.setText(_translate("viewReservations", "Done"))
