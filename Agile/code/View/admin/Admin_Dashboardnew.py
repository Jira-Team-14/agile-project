...
"")
        ...
        self.addButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showEmployessManagment())
        ...
        self.modifyButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showBuildingManagment())
        ...
        self.deleteButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showReservationsManagment())
