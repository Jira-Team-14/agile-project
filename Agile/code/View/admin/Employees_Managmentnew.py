...
class Ui_Employees_Managment(object):
    ...
    def setupUi(self, Employees_Managment):
        ...
        self.deleteButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showaDeleteEmployees())
...
"")
        ...
        self.addButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showAddNewEmployees())
...
"")
        ...
        self.modifyButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showModifyEmployees())
