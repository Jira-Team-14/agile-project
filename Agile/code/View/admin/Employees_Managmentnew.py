...
import addNewEmployeesnew as addE
import modifyEmployeenew as mE
import deleteEmployeenew as DE
...
class Ui_Employees_Managment(object):
    ...
    def logOut(self,Employees_Managment):
    ...
    def back(self,Employees_Managment):
    ...
    def showAddNewEmployees(self,Employees_Managment):
    ...
    def showModifyEmployees(self,Employees_Managment):
    ...
    def showaDeleteEmployees(self,Employees_Managment):
    ...
    def setupUi(self, Employees_Managment):
        ...
        self.deleteButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showaDeleteEmployees(Employees_Managment))
...
"image: url(businessman (1).png);")
        ...
        self.adminDashboardLabel_2.setGeometry(QtCore.QRect(260, 240, 511, 71))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"")
        ...
        self.addButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showAddNewEmployees(Employees_Managment))
        ...
        self.showResidentInfoPushButton_3 = QtWidgets.QPushButton(self.centralwidget,  clicked=lambda: self.back(Employees_Managment))
...
"")
        ...
        self.adminDashboardLabel_3.setGeometry(QtCore.QRect(202, 140, 631, 71))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"")
        ...
        self.modifyButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showModifyEmployees(Employees_Managment))
...
"")
        ...
        self.showResidentInfoPushButton_2 = QtWidgets.QPushButton(self.centralwidget,  clicked=lambda: self.logOut(Employees_Managment))
...
"")
    ...
    def retranslateUi(self, Employees_Managment):
        ...
        self.adminDashboardLabel_3.setText(_translate("Employees_Managment", "Admin Dashboard"))
