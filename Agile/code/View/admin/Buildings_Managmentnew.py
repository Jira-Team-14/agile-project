...
class Ui_Buildings_Managment(object):
    ...
    def showaddNewBuildings(self,Buildings_Managment):
    ...
    def showmodifyBuilding(self,Buildings_Managment):
    ...
    def showdeleteBuilding(self,Buildings_Managment):
    ...
    def back(self,Buildings_Managment):
    ...
    def logOut(self,Buildings_Managment):
    ...
    def setupUi(self, Buildings_Managment):
        ...
        self.showResidentInfoPushButton_3 = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.back(Buildings_Managment))
...
"")
        ...
        self.showResidentInfoPushButton_2 = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.logOut(Buildings_Managment))
...
"")
        ...
        self.addButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showaddNewBuildings(Buildings_Managment))
        ...
        self.deleteButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showdeleteBuilding(Buildings_Managment))
        ...
        self.modifyButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda: self.showmodifyBuilding(Buildings_Managment))
